...
export class TwitchLiveClockStack extends Stack {
  constructor(scope: Construct, id: string, props?: TwitchLiveClockStackProps) {
    ...
    const handler = new NodejsFunction(this, `TwitchLiveClockStartTimeHandler${config.resourceNameSuffix}`, {
    ...
    const api = new HttpApi(this, `TwitchLiveClockApi${config.resourceNameSuffix}`, {
      corsPreflight: {
        allowOrigins: ['*'],
